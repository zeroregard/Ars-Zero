...
public class FastPoofParticle extends TextureSheetParticle {
    ...
    protected FastPoofParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet spriteSet) {
        super(level, x, y, z, xSpeed, ySpeed, zSpeed);
        this.gravity = 0.0f;
        // POOF typically lasts ~8 ticks, so 2x faster = 4 ticks
        this.lifetime = 4;
        this.initialSize = 0.4f + (float)(Math.random() * 0.2);
