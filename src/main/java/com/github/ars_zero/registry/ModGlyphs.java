...
import com.github.ars_zero.common.glyph.ConjureArcaneShieldEffect;
...
public class ModGlyphs {
    ...
    public static final ConjureArcaneShieldEffect CONJURE_ARCANE_SHIELD_EFFECT = new ConjureArcaneShieldEffect();
    ...
    public static void registerGlyphs() {
        ...
        ArsZero.LOGGER.debug("Registering ConjureArcaneShieldEffect glyph...");
        GlyphRegistry.registerSpell(CONJURE_ARCANE_SHIELD_EFFECT);
        ArsZero.LOGGER.info("Successfully registered ConjureArcaneShieldEffect glyph with ID: {}", CONJURE_ARCANE_SHIELD_EFFECT.getRegistryName());
