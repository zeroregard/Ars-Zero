...
public class NecroCrownArmor extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public NecroCrownArmor(Holder<ArmorMaterial> material) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private GeoArmorRenderer<NecroCrownArmor> renderer;
            ...
            public @Nullable <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
                ...
                if (renderer == null) {
                    renderer = new com.github.ars_zero.client.renderer.armor.NecroCrownRenderer();
                }
                return renderer;
            }
        });
