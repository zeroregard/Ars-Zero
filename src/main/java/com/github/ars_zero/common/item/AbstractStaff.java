...
public abstract class AbstractStaff extends AbstractMultiPhaseCastDevice implements GeoItem {

    public AbstractStaff(SpellTier tier) {
    ...
    private <P extends AbstractStaff & GeoItem> PlayState idlePredicate(AnimationState<P> event) {
        ...
        if (FMLEnvironment.dist == Dist.CLIENT) {
            ...
            if (mc != null && mc.player != null) {
                boolean isUsing = mc.player.isUsingItem() && 
                    mc.player.getUseItem().getItem() instanceof AbstractStaff;
