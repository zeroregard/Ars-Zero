...
/**
 * QA testing staff: Begin = Projectile + Convergence + Explosion,
 * Tick = Temporal Context + Anchor, End = Temporal Context + Explosion.
 * Covers EffectConvergence + Explosion temporal context.
 */
public class StaffConvergence extends AbstractStaticSpellStaff {

    private static final String SPELL_NAME = "Staff of the Explosion Arch Wizard";

    public StaffConvergence() {
        super();
    }
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull Item.TooltipContext context, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.ars_zero.staff_convergence.desc"));
    }
    ...
    protected void applyPresetSpells(ItemStack stack) {
        ...
        AbstractSpellPart convergence = GlyphRegistry.getSpellPart(ArsZero.prefix("effect_convergence"));
        ...
        if (projectile == null || convergence == null || explosion == null || temporalContext == null || anchor == null) {
            return;
        }

        Spell beginSpell = new Spell(projectile, convergence, explosion).withName(SPELL_NAME);
