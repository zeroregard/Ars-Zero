...
public class RottedArcanistArmor extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public RottedArcanistArmor(Holder<ArmorMaterial> material, Type type) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private GeoArmorRenderer<RottedArcanistArmor> renderer;
            ...
            public @Nullable <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
                ...
                if (renderer == null) {
                    renderer = new com.github.ars_zero.client.renderer.armor.RottedArcanistRenderer();
                }
                return renderer;
            }
        });
