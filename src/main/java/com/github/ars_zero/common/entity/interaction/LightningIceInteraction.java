...
public class LightningIceInteraction implements VoxelInteraction {
    ...
    public boolean shouldInteract(com.github.ars_zero.common.entity.BaseVoxelEntity primary, com.github.ars_zero.common.entity.BaseVoxelEntity secondary) {
        return (primary instanceof LightningVoxelEntity && secondary instanceof IceVoxelEntity) ||
               (primary instanceof IceVoxelEntity && secondary instanceof LightningVoxelEntity);
    }
