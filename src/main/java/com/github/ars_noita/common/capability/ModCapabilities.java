...
@EventBusSubscriber(modid = ArsNoita.MOD_ID)
public class ModCapabilities {
    
    public static final EntityCapability<IPlayerTranslationCapability, Void> TRANSLATION_CAPABILITY = 
        EntityCapability.createVoid(ArsNoita.prefix("translation"), IPlayerTranslationCapability.class);
    
    @SubscribeEvent
    public static void registerCapabilities(RegisterCapabilitiesEvent event) {
        ArsNoita.LOGGER.info("Registering player translation capability");
