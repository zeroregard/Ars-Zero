...
import com.github.ars_noita.common.entity.VoxelEntity;
...
public class ModEntities {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, ArsNoita.MOD_ID);
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<VoxelEntity>> VOXEL_ENTITY = ENTITIES.register(
            ...
            () -> EntityType.Builder.<VoxelEntity>of(VoxelEntity::new, MobCategory.MISC)
                    ...
                    .noSave()
                    .build(ArsNoita.MOD_ID + ":voxel_entity")
    );
}
